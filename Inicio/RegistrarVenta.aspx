<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarVenta.aspx.cs" Inherits="Inicio.RegistrarVenta" %>
<!DOCTYPE html>
...
&nbsp;<asp:RadioButton ID="RbtnMesh" runat="server" GroupName="Material" Text="Mesh" />
&nbsp;<asp:RadioButton ID="RbtnBacklit" runat="server" GroupName="Material" Text="Backlit" />
            </p>
            <p> 
...
&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <p> 
                <asp:Label ID="LblAfinado" runat="server" Text="Afinado"></asp:Label>
            </p>
            <p> 
                <asp:RadioButton ID="RbtnRecto" runat="server" GroupName="Afinado" Text="Recto" Checked="True" />
&nbsp;<asp:RadioButton ID="RbtnOjillos" runat="server" GroupName="Afinado" Text="Ojillos" />
&nbsp;<asp:RadioButton ID="RbtnPendon" runat="server" GroupName="Afinado" Text="Pendon" />
            </p>
            <p> 
